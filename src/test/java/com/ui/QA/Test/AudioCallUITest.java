...
public class AudioCallUITest extends BaseTest {
...
//        getDriver().activateApp("com.dating.for.all.debug");
    ...
    public void checkIfTheUserShouldBeAbleToClickOnCreateButtonFromHomeScreenToHostVoiceCallForFemaleUser() throws InterruptedException {
        ...
        hostedAudioCallPage1.verifyThreeDotClickableAndAllIconsPresent(getDriver1());
        hostedAudioCallPage1.verifyHowToEarnRewardButtonClickable(getDriver1());
        hostedAudioCallPage1.verifyListOfFramesDisplayedWhenHostClickOnItsOwnAvatar(getDriver1());
        hostedAudioCallPage1.verifyAfterClickingOnFrameBuyNowButtonDisplayedAndClickable(getDriver1());
      //  hostedAudioCallPage1.verifyFramesScrollableAndFreeFrameApply(getDriver1());
        hostedAudioCallPage1.verifyGemAndCoinsIconDisplayedOnFrameWindow(getDriver1());
